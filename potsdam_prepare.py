### PREPARE POTSDAM IMAGES - MODIFIED BY MAX. ORIGINAL IS
# https://github.com/xu-ji/IIC/blob/master/code/datasets/segmentation/util/potsdam_prepare.py
# splits each 6000x6000 image into 15x15 half scaled 200x200 images
# makes train and test lists

# the results are saved as .mat files which is a bit annoying but oh well,,,
# I can always change this I guess

# things to note: gt stands for ground truth
...
# data directories
SOURCE_IMGS_DIR = "/mnt/D2/Data/potsdam/raw/4_Ortho_RGBIR"
SOURCE_IMGS_SUFFIX = "_RGBIR.tif"
SOURCE_GT_DIR = "/mnt/D2/Data/potsdam/raw/5_Labels_for_participants"
SOURCE_GT_SUFFIX = "_label.tif"
NUM_SOURCE_IMGS = 38
NUM_SOURCE_GT = 24

# output directories
OUT_DIR = "/mnt/D2/Data/potsdam/preprocessed"
...
#     img = np.array(tif).astype(np.uint8)
    ...
    # is there a ground truth file for this image??
