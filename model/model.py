...
#             torch.nn.init.xavier_uniform_(m.weight) ### bad!!!
...
class AR_residual_block_noup(nn.Module):
    ...
    def __init__(self, in_channels):
        ...
        # first sub-block
        self.conv1 = shiftedMaskedConv2d(in_channels, in_channels, kernel_size=3, padding=0)
...
class ARSegmentationNet2A(nn.Module):
    ...
    def __init__(self, in_channels=3, num_classes=3):
        ...
        self.resblock1 = AR_residual_block(64)
        self.attn = attentionLayer(128, 32, 32, 50)
        self.resblock2 = AR_residual_block(128)
...
class ARSegmentationNet3A(nn.Module):
    ...
    def __init__(self, in_channels=3, num_classes=3):
        ...
        self.resblock1 = AR_residual_block(64)
        self.resblock2 = AR_residual_block(128)
        self.attn = attentionLayer(256, 32, 32, 50)
        self.resblock3 = AR_residual_block(256)
...
class ARSegmentationNet4(nn.Module):
    ...
    def __init__(self, in_channels=3, num_classes=3, stride=1):
        ...
        self.resblock1 = AR_residual_block(64)
        self.resblock2 = AR_residual_block(128)
#         self.resblock3 = AR_residual_block_noup(256)
#         self.resblock4 = AR_residual_block_noup(256)
#         self.decoder = decoder(256, num_classes, upsample=2*stride)
        self.resblock3 = AR_residual_block(256)
...
# class ARVGG(nn.Module):
#     def __init__(self, in_channels=3, num_classes=3, stride=1):
#         super().__init__()
#         self.conv1 = nn.Conv2d(in_channels, 64, kernel_size=3, padding=1, stride=stride)
#         self.bn = nn.BatchNorm2d(64)
#         self.conv2 = shiftedMaskedConv2d(64, 128, kernel_size=3, padding=0)
#         self.pool = nn.MaxPool2d(kernel_size=(3,3), stride=2, padding=1)
#         self.conv3 = shiftedMaskedConv2d(128, 256, kernel_size=3, padding=0)
#         self.conv4 = shiftedMaskedConv2d(256, 256, kernel_size=3, padding=0)
#         self.conv5 = shiftedMaskedConv2d(256, 512, kernel_size=3, padding=0)
#         self.conv6 = shiftedMaskedConv2d(512, 512, kernel_size=3, padding=0)
#         self.decoder = decoder(512, num_classes, upsample=2*stride)
        
#     def forward(self, x, ordering):
#         x = self.conv1(x)
#         x = self.bn(x)
#         x = self.conv2(x, ordering)
#         x = self.pool(x)
#         x = self.conv3(x, ordering)
#         x = self.conv4(x, ordering)
#         x = self.conv5(x, ordering)
#         x = self.conv6(x, ordering)
#         return self.decoder(x)
